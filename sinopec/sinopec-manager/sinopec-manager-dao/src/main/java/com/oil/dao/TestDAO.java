...
public class TestDAO {
	...
	public Test findById(java.lang.Integer id) {
		...
		try {
			Test instance = (Test) getCurrentSession().get(
					"com.oil.entity.Test", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Test> findByExample(Test instance) {
		...
		try {
			List<Test> results = (List<Test>) getCurrentSession()
					.createCriteria("com.oil.entity.Test")
	...
	public Test merge(Test detachedInstance) {
		...
		try {
			Test result = (Test) getCurrentSession().merge(detachedInstance);
