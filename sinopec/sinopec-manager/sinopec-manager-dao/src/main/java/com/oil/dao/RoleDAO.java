...
public class RoleDAO {
	...
	public List<Role> findByExample(Role instance) {
		...
		try {
			List<Role> results = (List<Role>) getCurrentSession()
					.createCriteria("com.oil.entity.Role")
	...
	public List<Role> findByNote(Object note) {
		return findByProperty(NOTE, note);
	}

	public List<Role> findByPermissions(Object permissions) {
